...
RouteConfig={
    ...
    "kitPage":{"name":"探索","route":"kitPage","titlename":"鹿鸣测评","icon":IconConfig.IconKit},
        ...
        "LunarCoursePage":{"name":"思无邪","route":"LunarCoursePage","titlename":"思无邪","icon":IconConfig.IconLunarCourse},
        ...
        "ShengYunBookPage":{"name":"声律启蒙","titlename":"声律启蒙","route":"ShengYunBookPage","icon":IconConfig.IconShengYun},
        

        "ThreeExtPage":{"name":"三玄","titlename":"三玄","route":"","icon":IconConfig.IconThreeIntro},
        "FourExtPage":{"name":"四书","titlename":"四书","route":"","icon":IconConfig.IconThreeIntro},
        "FiveExtPage":{"name":"五经","titlename":"五经","route":"","icon":IconConfig.IconThreeIntro},
        "AncientChineseLiteraturePage":{"name":"小学","route":"LanguagesCoursePage","icon":IconConfig.IconLunarCourse},
            "UniversBookPage":{"name":"易经","titlename":"易经","route":"UniversBookPage","icon":IconConfig.IconUniversBook},
            "OldBookPage":{"name":"老子","titlename":"道德经","route":"OldBookPage","icon":IconConfig.IconOldBook},
            "ZhuangBookPage":{"name":"庄子","titlename":"庄子","route":"ZhuangBookPage","icon":IconConfig.IconZhuangBook},
            "LunyuBookPage":{"name":"论语","titlename":"论语","route":"LunyuBookPage","icon":IconConfig.IconLunYuBook},
            "MengziBookPage":{"name":"孟子","titlename":"孟子","route":"MengziBookPage","icon":IconConfig.IconMengZiBook},
            "ZhongBookPage":{"name":"中庸","route":"ZhongBookPage","icon":IconConfig.IconZhongYongBook},
            "BigBookPage":{"name":"大学","titlename":"大学","route":"BigBookPage","icon":IconConfig.IconBigBook},
            "ShijingBookPage":{"name":"诗经","route":"","icon":IconConfig.IconShiJingBook},
